            ...
            <div class="main-article-box">
                ...
                <div class="main-article-content-box">
                    ...
                    <div class="main-article-content">
                        ...
                        <p class="main-article-p">
                            {{article[0].content.p2}}
                        </p>
                        <p class="main-article-p">
                            {{article[0].content.p3}}
                        </p>
                        <p class="main-article-p">
                            {{article[0].content.p4}}
                        </p>
                        ...
                        <p class="main-article-p">
                            {{article[0].content.p6}}
                        </p>

                        <p class="main-article-p">
                            {{article[0].content.p7}}
                        </p>
...
export default {
    data: function () {
        return {
          article: [
            {
                title: "Ten Years After The Financial Crisis, The Contagion Has Spread To Democracy Itself",
                category: "POLITICS",
                author: "Zach Carter",
                authorCredentials: "Senior Political Economy Reporter, HuffPost",
                authorSocial: "https://twitter.com",
                description: "Tim Geithner, Ben Bernanke and Hank Paulson dealt a catastrophic blow to public faith in American institutions.",
                timestamp: "09/15/2018 10:50 pm ET",
                img:
                    "https://img.huffingtonpost.com/asset/5b9d80ca2500003500367c9a.jpeg?cache=ux943pagyc&ops=crop_17_40_2983_1234,scalefit_970_noupscale",
                imgCaption: "Ben Bernanke (right) and Timothy Geithner (background) say they did what they had to do to “prevent the collapse of the financial system and avoid another Great Depression.” But what they really did was teach middle-class families a grim lesson.",
                id: "001",
                route: "/",
                content: {
                    p1: "By the time Lehman Brothers filed for the largest bankruptcy in American history on Sept. 15, 2008, the country had been navigating stormy global financial waters for more than a year. Bear Stearns had been rescued in a bailout-facilitated merger with JPMorgan Chase, and the government had nationalized housing giants Fannie Mae and Freddie Mac. For anyone paying attention to the financial system, the situation had been quite dire for a long time.",
                    p2: "And yet throughout the mess, the Federal Reserve and the U.S. Treasury had been permitting the largest banks in the country to funnel as much cash as they wanted to their shareholders ― even as it became clear those same banks could not pay their debts. " + 
                        "Lehman itself had increased its dividend and announced a $100 million stock buyback at the beginning of 2008. Insurance giant AIG paid a dividend of $4.40 per share, the highest in company history, on Sept. 19, 2008 ― three days after the Federal Reserve handed the insurance giant $85 billion in emergency funds. " +
                        "According to Stanford University Business School Professor Anat Admati, the 19 biggest American banks passed out $80 billion in dividends between the summer of 2007 and the close of 2008. They drew $160 billion in bailout funds from the U.S. Treasury, and untold billions from the Fed’s $7.7 trillion in emergency lending. ",
                    p3: "When poor people engage in such activity, we call it looting. But for the princes of American capital and their lieutenants at the Fed and the Treasury, this was pure crisis management. " + 
                        ...
                        "Except they didn’t really rescue the banking system. They transformed it into an unaccountable criminal syndicate. " +
                    ...
                    p4: "For most of American history, financial policy was a central political battleground. There was the feud between Thomas Jefferson and Alexander Hamilton over Revolutionary War debt; the Whiskey Rebellion; Andrew Jackson’s assault on the Second Bank of The United States; the greenbacks Abraham Lincoln issued to help finance the Civil War; William Jennings Bryan and the cross of gold; the creation of the Federal Reserve; FDR’s New Deal. " +
                        "These were among the most heated political issues of their day. And they were all understood to be questions of power and democratic accountability, not merely matters of growth or efficiency.",
                    p5: "But beginning in the 1950s, the United States increasingly came to understand finance as apolitical ― something best handled by technocratic experts insulated from the passions of a democratic electorate. This idea went by different slogans ― “the liberal consensus,” “the great moderation,” “central bank independence” ― but they all amounted to the same thing: The economy was nonideological. " +
                        "The decisions made by experts tending to the financial machine were were strictly tactical. Any mistakes were a matter of pulling the wrong lever or setting a dial too high.",
                    p6: "The financial crisis exploded this myth. “The failures of the crash and the bailout were not technocratic failures,” says University of Georgia law professor Mehrsa Baradaran. “They were about power.”",
                    p7: "Lehman would be the only major American financial institution to out-and-out fail in the crisis. Everyone else was bailed out on generous terms that not only protected their creditors, but their shareholders and ― with the exception of AIG ― the jobs of their top executives. Criminals who broke the law were shielded from prosecution. " +
                ...
                quote: "The failures of the crash and the bailout were not technocratic failures. They were about power.",
                quoteAuthor: "University of Georgia law professor Mehrsa Baradaran"
            }
          ]
        }
    }
